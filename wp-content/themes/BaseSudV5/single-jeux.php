...
// if ($current_user != 1){ //First template
?>
...
<?php get_header(); ?>
  ...
  <section class="Single container row d-flex flex-wrap LightBox" style="display:none !important;">
  <span class="closeBtnLightBox">x</span>
      <!-- Section thumbs products -->
      <div class="containThumbSingle col-md-12">
        <div class="blockLeftSingle">
          <?php the_post_thumbnail(); ?>
        </div>
          <!-- Caropusel product galerie -->
        <?php if (have_rows('galerie_produits')) : ?>
        <div class="blockLeftSingleSlide">
          <div class="blockNavSlide">
            <div class="slider-nav">
              <?php while (have_rows('galerie_produits')) : the_row(); ?>
              <div class="blockNavImgSlide">
        ...
        <?php endif; ?>
        <!-- END Caropusel product galerie -->
      </div>
      <!-- END Section thumbs products -->
      </section>
  <!-- END LightBox Produits -->
    ...
    <section class="Single container row d-flex flex-wrap">
      ...
      <!-- Section thumbs products -->
      <div class="containThumbSingle col-md-6">
        <div class="blockLeftSingle blockGalerieProduit notlightbox">
          <?php the_post_thumbnail(); ?>
        </div>
          <!-- Caropusel product galerie -->
        <?php if (have_rows('galerie_produits')) : ?>
...
.blockimgCurrebtSlide img:hover {
  opacity: 0;
}
.blockimgCurrebtSlide img {
  transition: opacity .5s;
  display: block;
  width: 100%;
}
.single .blockLeftSingle {
    margin: 0px 0px !important;
    width: auto !important;
    border: solid #d1d1d1  1px;
    overflow: hidden;
}
.single .blockLeftSingle img {
    max-height: 360px;
}
