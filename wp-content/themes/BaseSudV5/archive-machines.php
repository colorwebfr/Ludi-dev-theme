...
<!--///////////////////////////////////// Hero Archive /////////////////////////////////////-->
<?php
$accroche_hero = get_field('titre_daccroche_machines', 'option') ? get_field('titre_daccroche_machines', 'option') : "LUDI SFM PRESENTE :";
$title_hero = get_field('titre_machines', 'option') ? get_field('titre_machines', 'option') : "Les Machines";
?>
...
<?php
$color_nav = get_field('couleurs_de_navigation__page_darchives_machines__', 'option') ? get_field('couleurs_de_navigation__page_darchives_machines__', 'option') : "#000000";
$visuelHero = get_field('visuel_archives_machines', 'option') ? "url('".get_field('visuel_archives_machines', 'option')['url']."')" : "url('/wp-content/uploads/2022/05/machine-a-sous.png')"; 
$couleur_fondHero = get_field('couleur_de_fond_hero_machines', 'option') ? get_field('couleur_de_fond_hero_machines', 'option') : "linear-gradient(120deg, rgba(22,42,111,1) 44%, rgb(199 98 196) 100%);"; 
?>
